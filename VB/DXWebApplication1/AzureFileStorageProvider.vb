...
Namespace DXWebApplication1
    Public Class AzureFileStorageProvider
        ...
        Private Const accountName As String = "YourAccountName"
        Private Const keyValue As String = "YourKeyValue"
        Private Const shareName As String = "YourShareName"
        Private cred As StorageCredentials = New Microsoft.WindowsAzure.Storage.Auth.StorageCredentials(accountName, keyValue)
        ...
        Private rootFolderDisplayName_Renamed As String = "root"
        ...
        Private Function GetDirectory(ByVal prefix As String) As CloudFileDirectory
            Return If(prefix = "", rootDirectory, rootDirectory.GetDirectoryReference(prefix))
        End Function
        ...
        Private Sub CopyFolderInternal(ByVal sourceFolder As CloudFileDirectory, ByVal targetFolder As CloudFileDirectory, ByVal directoryName As String)
            ...
            For Each item As IListFileItem In items
                If DirectCast(item, Object).GetType() Is GetType(CloudFile) Then
                    Dim file = DirectCast(item, CloudFile)
                    newFolder.GetFileReference(file.Name).StartCopy(file)
                Else
                    Dim directory = DirectCast(item, CloudFileDirectory)
